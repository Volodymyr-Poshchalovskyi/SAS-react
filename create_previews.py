...
BASE_TRANSCODED_DIRECTORY = "front-end/05-Feature film packaging/01-lana del rey - ride/TRANSCODED/"
# Базова папка, куди будемо складати всі прев'ю
DESTINATION_BASE_DIRECTORY = "front-end/05-Feature film packaging/01-lana del rey - ride/VIDEO_PREVIEW"
# ----------------------------------------------------
