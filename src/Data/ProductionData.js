...
export const productionData = [
  ...
  {
    id: 2,
    title: 'Maybelline | Makeup Your Mix',
    projectSlug: 'maybelline-makeup-your-mix',
    src: 'front-end/04-Service/TRANSCODED/02-Maybelline-Makeup Your Mix 2023/master.m3u8',
    preview_src: 'front-end/04-Service/VIDEO_PREVIEW/04-Service/02-Maybelline-Makeup Your Mix 2023.jpg',
    featuring: 'Placeholder Artist',
    director: 'Placeholder Director',
    executiveProducers: 'Placeholder Producer',
    description:
  ...
  {
    id: 3,
    title: "Tiffany's | Believe In Dreams",
  ...
  {
    id: 4,
    title: 'Maybelline | TTL x Gigi Hadid',
  ...
  {
    id: 7,
    title: 'Ermenegildo Zegna | Game Vs Sport',
  ...
  {
    id: 8,
    title: 'Louis Vuitton | Horizon Soft',
  ...
  {
    id: 9,
    title: 'Calvin Klein | Margot Robbie',
